...
export const GetSupergraphManager = (storage: Storage, configuration: Configuration): SupergraphManager => {
    switch(storage){
        case Storage.Local:
        ...
        default:
          throw new SupergraphManagerError({type: EnumOfErrorTypes.BadStorageType, message: "Invalid storage!"})
      }
}
